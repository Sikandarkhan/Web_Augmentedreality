window.blueprint = window.blueprint || {}, blueprint.Converter = function(a, b) {
    ...
    var k = function(b, f, g) {
        ...
        l = new AR.Trackable2DObject(i, f.label.toString(), {
                                    ...
                                    // trackableObjects[this.trackableID].snapToScreen.enabled=false;
                                     ...
                                     $('#scannerStatus').text("Loading Content");
                                    ...
                                    $('#loader').css("visibility","hidden");
                                     ...
                                     setTimeout(
                                                ...
                                                if($('#scannerStatus').text()=="Loading Content")
                                                {
    ...
    z = function(a) {
        ...
        return "http://s3-ap-southeast-1.amazonaws.com/revmediacdn/targets.wtc";
