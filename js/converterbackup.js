  ...
  var currentLabel=undefined;
    ...
    var k = function(b, f, g) {
        ...
        l = new AR.Trackable2DObject(i, f.label.toString(), {
                              ...
                              //       if(l.snappedOnce!=undefined)
                                    // {
                               //l.snapToScreen.enabled=false;
                            //}
                                    ...
                                    currentLabel=f.label.toString();
                                     ...
                                     if(previousCampaigns.length==0 || previousCampaigns.indexOf(currentLabel)==-1)
                                     {
                                       ...
                                       $('#scannerStatus').css("visibility","visible");
                                         ...
                                         $('#scannerText').text("Loading Content");
                                     ...
                                     this.snapToScreen.snapContainer=document.getElementById("snapContainer");
                                      this.snapToScreen.enableDelayed=2000;
                ...
                onSnappedToScreen :function(divContainer)
                {
                    // this.snappedOnce=true;


$('.snap-close').css("display","block");
$('.intro-section').css("display","none");
      ...
      //  previouslyIdentified2DObject.snapToScreen.enableOnExitFieldOfVision=true;
        ...
        //                                console.log(previous2DObject);

                 

                                      //  previous2DObject.l=l;
   ...
   //     previouslyIdentified2DObject.snapToScreen.enableOnExitFieldOfVision=true;
       ...
       /*
                                   ...
                                   */
                                     ...
                                     l.destroyTimer = null
                                     }, l.destroyTimer = window.setTimeout(/*l.destroyDrawables*/console.log("destroy timer called"), e), k(l) 
                                     } : function() {
                                     k(l)
                                     }
                                     });
    ...
    n = function(a, b, d) {
        return function() {
            ...
            if (e.style = {
                ...
                var f = function() {
                    AR.context.openInBrowser(d.clickUrl,true)
                };
                e.onClick = e.onClick ?
                function(a, b) {
                    return function() {
    ...
    t = function(a, b, c) {
        return function() {
            if (c.autoPlay) f = new AR.Circle(1, {
                ...
                "PrivateVideo" == c.subType ? AR.context.startVideoPlayer(c.src) : AR.context.openInBrowser(c.src,true)
            };
            else {
                var d = u(a, b, c),
